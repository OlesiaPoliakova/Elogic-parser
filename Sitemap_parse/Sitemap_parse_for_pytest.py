...
def parse_sitemap(url, global_domain, regional_domains):
...
def main():
    # Define the global and regional domains for this sitemap
    ...
    for sitemap_url in sitemap_urls:
        parse_sitemap(sitemap_url, global_domain, regional_domains)
